...
//       // variable to store the list of possible answer
//       const answer = [];
...
//     const answerContainer = quizContainer.querySelectorAll('.answer');
...
//         // color the green if answer is correct 
//         answerContainer[questionNumber].style.color = 'lightgreen';
//     }

//     // if answer is wrong or blank
//     else{
//       // color the red if answer is wrong
...
//   slides[currentSlides].classList.remove('active-slide');
